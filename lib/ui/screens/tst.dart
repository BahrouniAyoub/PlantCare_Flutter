...
//   String? ollamaCareTip;
//   String? ollamaSensorAdvice;
...
//   Future<void> _askOllamaForCareTips() async {
//     setState(() {
//       _isAskingCareTip = true;
//       ollamaCareTip = null;
//     });

//     final prompt = "Give care tips for a plant called ${widget.plant.name}.";
//     final response = await http.post(
//       Uri.parse('http://10.0.2.2:11434/api/generate'),
//       headers: {'Content-Type': 'application/json'},
//       body: jsonEncode({"model": "mistral", "prompt": prompt, "stream": false}),
//     );

//     if (response.statusCode == 200) {
//       final body = jsonDecode(response.body);
//       setState(() {
//         ollamaCareTip = body['response'];
//       });
//     } else {
//       setState(() {
//         ollamaCareTip = 'Failed to get response from Ollama.';
//       });
//     }

//     setState(() {
//       _isAskingCareTip = false;
//     });
//   }

//   Future<void> _askOllamaForSensorAdvice() async {
//     final temp = latestTemperature?.toStringAsFixed(1) ?? 'unknown';
//     final hum = latestHumidity?.toStringAsFixed(1) ?? 'unknown';

//     final prompt =
//         "You are a plant expert. Based on the sensor readings: temperature \${temp}°C and humidity \${hum}%, provide advice for this plant: \${widget.plant.name}.";
...
//       final body = jsonDecode(response.body);
//       setState(() {
//         ollamaSensorAdvice = body['response'];
//       });
//     } else {
//       setState(() {
//         ollamaSensorAdvice = 'Failed to get sensor-based advice from Ollama.';
//       });
//     }
//   }
...
//           children: [
//             ElevatedButton(
//               onPressed: _askOllamaForSensorAdvice,
...
//               ),
//               child: const Text(
//                 "🌡️💧 Ask AI for Sensor-Based Advice",
...
//             children: [
//               ElevatedButton(
//                 onPressed: _askOllamaForCareTips,
//                 child: const Text("Ask AI for care tips"),
//               ),
//               Card(
...
//               else if (ollamaCareTip != null)
//                 Text(ollamaCareTip!, style: const TextStyle(fontSize: 16))
